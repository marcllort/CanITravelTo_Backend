...
- [CanITravelTo](#canitravelto)
  ...
  * [EC2 Ubuntu](#ec2-ubuntu)
    + [To ssh into AWS Ubuntu machine:](#to-ssh-into-aws-ubuntu-machine-)
  ...
  * [Deprecated developments:](#deprecated-developments-)
    + [Compile to AWS [Deprecated, now using Docker]:](#compile-to-aws--deprecated--now-using-docker--)
        * [To upload the new build:](#to-upload-the-new-build-)
        * [Create service in Ubuntu](#create-service-in-ubuntu)
    + [Frontend React [Deprecated, now using vanilla HTML/CSS]](#frontend-react--deprecated--now-using-vanilla-html-css-)
